# coding: utf-8
#
#  Be sure to run `pod spec lint QuizTrain.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name         = "QuizTrain"
  s.version      = "2.0.1"
  s.summary      = "Swift Framework for TestRail's API"
  s.description  = <<-DESC
QuizTrain is a framework created at Venmo allowing you to interact with TestRail's API using Swift. It supports iOS, macOS, tvOS, and watchOS.
  ...
  s.homepage     = "https://github.com/kschillz/QuizTrain"
  ...
  s.source_files  = "QuizTrain/**/*{.swift,.h}"
